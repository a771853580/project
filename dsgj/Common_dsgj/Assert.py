...
"""
# from Common_dsgj import Log
# from Common_dsgj import Consts
import json
...
class Assertions:
    ...
    def assert_code(self, code, expected_code):
        ...
        try:
            ...
            print("statusCode error, expected_code is %s, statusCode is %s " % (expected_code, code))
    ...
    def assert_body(self, body, body_msg, expected_msg):
        ...
        try:
            ...
            print("Response body msg != expected_msg, expected_msg is %s, body_msg is %s" % (expected_msg, body_msg))
    ...
    def assert_text(self, body, expected_msg):
        ...
        try:
            ...
            print("Response body != expected_msg, expected_msg is %s, body is %s" % (expected_msg, body))
    ...
    def assert_time(self, time, expected_time):
        ...
        try:
            ...
            print("Response time > expected_time, expected_time is %s, time is %s" % (expected_time, time))
